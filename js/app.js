...
function renderProducts() {
  ...
  items.forEach((p, i) => {
    ...
    card.innerHTML = `
      ...
      <a href="product-${p.id}.html" class="product-card-link" aria-label="View ${p.name}">
